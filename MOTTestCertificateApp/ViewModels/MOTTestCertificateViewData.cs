...
namespace MOTTestCertificateApp.ViewModels
{
    public class MOTTestCertificateViewData : IMOTTestCertificateViewData
    {
        public MOTStatusDetails mOTStatusDetails { get; set; }
        public MOTTestCertificateDetails mOTTestCertificateDetails { get; set; }
